...
$myprice = get_sub_field('my_price');
...
<div class="col-lg-3 col-md-4  col-sm-6 ">
                      ...
                      <div class="ïmg-200x mlr-auto pos-relative">
                              ...
                              <h4 class="mt-5"><b>$ <?php echo $myprice ; ?> </b></h4>
...
<?php while( have_rows('our_menu') ): the_row(); 
        ...
        // vars
        $category_name = get_sub_field('category_name');
        $category = get_sub_field('category_');
      
        ?>

<div class="col-md-6 food-menu <?php echo sanitize_title( $category_name ) ; ?>">

<?php if( have_rows('category_') ): ?>
        <?php while( have_rows('category_') ): the_row(); 
...
?>
                                        ...
                                        <div class="sided-90x mb-30 ">
                                                <div class="s-left"><img class="br-3" src="<?php echo $image['url'] ;?>" alt="Menu Image"></div><!--s-left-->
                                                <div class="s-right">
                                                        <h5 class="mb-10"><b><?php echo $title ;?></b><b class="color-primary float-right">$12.00</b></h5>
